...
const Footer = () => {
  return (
    <footer className="relative overflow-hidden border-t border-white/10 bg-slate-950 text-white">
      ...
      <div className="relative mx-auto max-w-[1500px] px-4 py-9 sm:px-6 lg:px-8">
        {/* ================= TOP ================= */}
        ...
        <div className="grid gap-8 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
          ...
          <div>
            <Link to="/" className="group inline-flex items-center gap-3">
              ...
              <div>
                <p className="text-xl font-black tracking-tight">CodeArena</p>
            ...
            <div className="mt-5 flex gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/10 bg-white/[0.03] text-sm text-slate-400 transition hover:-translate-y-1 hover:border-violet-500/30 hover:bg-violet-500/10 hover:text-violet-300"
              >
                GH
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/10 bg-white/[0.03] text-sm font-bold text-slate-400 transition hover:-translate-y-1 hover:border-violet-500/30 hover:bg-violet-500/10 hover:text-violet-300"
              >
                in
              </a>
          ...
          <div>
            <h3 className="text-sm font-black text-white">CodeArena</h3>
        ...
        <div className="mt-5 overflow-hidden rounded-3xl border border-violet-500/10 bg-gradient-to-r from-violet-600/10 via-indigo-600/10 to-transparent p-5 sm:p-6">
        ...
        <div className="mt-7 flex flex-col gap-4 border-t border-white/10 pt-6 text-xs text-slate-600 sm:flex-row sm:items-center sm:justify-between">
